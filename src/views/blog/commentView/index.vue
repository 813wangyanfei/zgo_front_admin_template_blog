  ...
  <div class="system-user-container">
    <el-card shadow="hover">
      ...
      <el-table
        ...
        <el-table-column prop="create_time" label="评论时间" show-overflow-tooltip></el-table-column>
        <el-table-column prop="user" label="用户" show-overflow-tooltip></el-table-column>
        <el-table-column prop="article" label="文章" show-overflow-tooltip></el-table-column>
